...
body {
  ...
  background-image:url(https://kashmirconvener.com/wp-content/uploads/2016/06/Uttar-Pradesh-budget-1.jpg);
  background-color: ;
...
<body>
  <div class="login-form">
    <form action="" method="POST" autocomplete="off">
      <h2 class="text-center">Budget Manager</h2>
      <p class="hint-text">Chandigarh University</p>
